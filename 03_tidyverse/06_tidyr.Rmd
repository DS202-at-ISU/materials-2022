...
Work on the previously created data frame `returns`.
...
```
url <- "https://github.com/ds202-at-ISU/materials/blob/master/03_tidyverse/data/Iowa_Liquor_Sales.csv.zip?raw=TRUE"
