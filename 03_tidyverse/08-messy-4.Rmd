...
- Identify the four players who were inducted in the Hall of Fame in 2018 by the BBWAA (Baseball writers' association of America), by filtering the `Master` data for their player IDs. 
