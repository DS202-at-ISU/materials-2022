...
0. Setup 
    ...
    - this solution uses R v4.1.2 in RStudio (2022.07.1 Build 554). 
...
2. Download  the file [`test-case-solution.Rmd`](https://raw.githubusercontent.com/ds202-at-ISU/materials/master/01_collaborative-environment/test-case-solution.Rmd) in folder  `01_collaborative-environment`  in RStudio to get this set of slides.
