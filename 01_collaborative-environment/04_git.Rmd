...
As of January 8, 2019, free accounts can have [unlimited private repositories](https://arstechnica.com/gadgets/2019/01/free-github-accounts-now-offer-private-repos/)

Github is free - [BUT](https://docs.github.com/en/repositories/working-with-files/managing-large-files/about-large-files-on-github): If you attempt to add or update a file that is larger than 50 MB, you will receive a warning from Git.

Github blocks uploads of more than 100 MB

Keep repos ideally to less than 1 GB, and less than 5 GB is strongly recommended (or you might get emails from Github)
